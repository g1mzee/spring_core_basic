...
public class ApplicationContextExtendsFindTest {
    ...
    @Test
    @DisplayName("부모 타입으로 조회시, 자손이 둘 이상 있으면, 중복오류가 발생한다.")
    ...
    @Test
    @DisplayName("부모 타입으로 조회시, 자손이 둘 이상 있으면, 빈 이름을 지정하면 된다.")
    ...
    @Test
    @DisplayName("특정 하위타입으로 조회하기") //별로 좋은 방법은 아니니 참고만 하자!
    void findByParentSubType() {
